...
project = u"flask-restless-client"
author = "GEM"
...
extlinks = {
    # 'issue': ('https://github.com/maarten-dp/flask-restless-client/issues
    # 'pr': ('https://github.com/maarten-dp/flask-restless-client/pulls
}
